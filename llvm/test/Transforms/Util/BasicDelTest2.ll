; RUN: opt %s -S -passes="basicdel" > %t1 
...
; CHECK-NOT: declare void @llvm.dbg.label(metadata) #1
...
; CHECK-NOT: declare void @llvm.dbg.value(metadata, metadata, metadata) #2
...
!18 = !DILocation(line: 4, column: 5, scope: !20)
